...
-- Q.11 Write a SQL query to find the top 1 most popular categories based on total sales in the year 2022.
...
-- Q.12: Write a SQL query to calculate the total cost of goods sold (COGS) for each category.

SELECT category, SUM(cogs) 
FROM retail_sales
GROUP BY 1

-- Q.13: Top 3 product categories with the highest average unit price
...
-- Q.14: Category with the lowest number of transactions
...
-- Q.15: Total revenue generated by each gender
